...
public class SearchCouponDto {
	...
	private String foodCode;            	// 식당 코드
	private String couponName;        	 	// 쿠폰명 (상품명)
	private String couponStartdate;      	// 쿠폰 유효기간 (시작)
	private String couponEnddate;         	// 쿠폰 유효기간 (마감)
	private String couponIntro;         	// 쿠폰 소개
	...
	private String foodKind;	// 음식 분류  ex) 한식, 중식 등 
	...
	private String referCode;	// 참조 코드 ,FOOD0013 / coupon0002
